terraform {
  ...
  backend "s3" {
    bucket = "terraform-microservices-2023"
...
resource "aws_iam_role" "containerAppBuildProjectRoleViglione" {
  name = "containerAppBuildProjectRoleViglione"
...
resource "aws_iam_role_policy" "containerAppBuildProjectRolePolicy" {
  role = aws_iam_role.containerAppBuildProjectRoleViglione.name
...
resource "aws_codebuild_project" "containerAppBuild" {
  ...
  queued_timeout = 480
  service_role   = aws_iam_role.containerAppBuildProjectRoleViglione.arn
  tags = {
    Environment = var.env
  }
...
resource "aws_iam_role" "apps_codepipeline_role-Viglione" {
  name = "apps_codepipeline_role-Viglione"
...
resource "aws_iam_role_policy" "apps_codepipeline_role_policy" {
  ...
  role = aws_iam_role.apps_codepipeline_role-Viglione.id
...
resource "aws_codepipeline" "python_app_pipeline" {
  ...
  role_arn = aws_iam_role.apps_codepipeline_role-Viglione.arn
  tags = {
    Environment = var.env
  }
...
resource "aws_ecs_cluster" "MicroServicesCluster" {
